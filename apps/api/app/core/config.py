...
class Settings(BaseSettings):
    ...
    asr_provider: Literal["disabled", "openai_compatible"] = "disabled"
    asr_api_key: str | None = None
    asr_base_url: str | None = None
    asr_model: str = "qwen3-asr"
    asr_response_format: Literal["auto", "json", "verbose_json"] = "auto"
    asr_timeout_sec: int = 300
    asr_min_match_score: float = 0.55
    provider_timeout_sec: int = 300
    llm_provider: str = "mock"
    llm_api_key: str | None = None
    llm_base_url: str | None = None
    llm_model: str = "mock-llm"
    llm_stream_progress_interval_sec: float = 2.0
    ...
    script_generation_concurrency: int = 2
